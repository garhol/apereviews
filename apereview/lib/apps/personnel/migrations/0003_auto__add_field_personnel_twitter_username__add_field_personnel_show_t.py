...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Personnel.twitter_username'
        db.add_column(u'personnel_personnel', 'twitter_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personnel.show_twitter_link'
        db.add_column(u'personnel_personnel', 'show_twitter_link',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Personnel.twitter_username'
        db.delete_column(u'personnel_personnel', 'twitter_username')

        # Deleting field 'Personnel.show_twitter_link'
        db.delete_column(u'personnel_personnel', 'show_twitter_link')
