...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'personnel_personnel', (
            ...
            ('bio_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('biography', self.gf('tinymce.models.HTMLField')()),
        ))
        db.send_create_signal(u'personnel', ['Personnel'])


    def backwards(self, orm):
        # Deleting model 'Personnel'
        db.delete_table(u'personnel_personnel')
