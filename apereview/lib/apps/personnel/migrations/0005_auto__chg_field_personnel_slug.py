...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Personnel.slug'
        db.alter_column(u'personnel_personnel', 'slug', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 5, 22, 0, 0), max_length=255))

    def backwards(self, orm):

        # Changing field 'Personnel.slug'
        db.alter_column(u'personnel_personnel', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
