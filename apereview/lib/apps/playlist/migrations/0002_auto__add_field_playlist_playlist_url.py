...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.playlist_url'
        db.add_column(u'playlist_playlist', 'playlist_url',
                      self.gf('django.db.models.fields.CharField')(default='http://www.apemanvinyl.com', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.playlist_url'
        db.delete_column(u'playlist_playlist', 'playlist_url')
    ...
    models = {
        ...
        u'playlist.playlist': {
            ...
            'playlist_url': ('django.db.models.fields.CharField', [], {'default': "'http://www.apemanvinyl.com'", 'max_length': '255'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
