...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_news', (
            ...
            ('label', self.gf('django.db.models.fields.CharField')(default='Apeman', max_length=255)),
            ('promo_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('news_banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('article', self.gf('tinymce.models.HTMLField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('news_status', self.gf('django.db.models.fields.CharField')(default='Live', max_length=15)),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reporter', to=orm['personnel.Personnel'])),
