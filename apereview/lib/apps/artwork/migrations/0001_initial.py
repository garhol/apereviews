...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArtCollection'
        db.create_table(u'artwork_artcollection', (
            ...
            ('collection_status', self.gf('django.db.models.fields.CharField')(default='Live', max_length=15)),
            ('collection_author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='artauthor', to=orm['personnel.Personnel'])),
            ('tags', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'artwork', ['ArtCollection'])

        # Adding model 'ArtItem'
        db.create_table(u'artwork_artitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artist', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('artwork', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('artcollection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artwork.ArtCollection'])),
        ))
        db.send_create_signal(u'artwork', ['ArtItem'])


    def backwards(self, orm):
        # Deleting model 'ArtCollection'
        db.delete_table(u'artwork_artcollection')

        # Deleting model 'ArtItem'
        db.delete_table(u'artwork_artitem')
