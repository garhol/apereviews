...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.label'
        db.add_column(u'reviews_review', 'label',
                      self.gf('django.db.models.fields.CharField')(default='Apeman', max_length=255),
                      keep_default=False)

        # Adding field 'Review.album_banner_image'
        db.add_column(u'reviews_review', 'album_banner_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.label'
        db.delete_column(u'reviews_review', 'label')

        # Deleting field 'Review.album_banner_image'
        db.delete_column(u'reviews_review', 'album_banner_image')
