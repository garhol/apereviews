...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.slug'
        db.alter_column(u'reviews_review', 'slug', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 5, 22, 0, 0), max_length=255))

    def backwards(self, orm):

        # Changing field 'Review.slug'
        db.alter_column(u'reviews_review', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
