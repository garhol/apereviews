...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reviews_review', (
            ...
            ('review', self.gf('tinymce.models.HTMLField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.CharField')(default='1', max_length=15)),
            ('review_status', self.gf('django.db.models.fields.CharField')(default='Live', max_length=15)),
            ('release_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewer', to=orm['personnel.Personnel'])),
