...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.spotifylink'
        db.add_column(u'reviews_review', 'spotifylink',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.spotifylink'
        db.delete_column(u'reviews_review', 'spotifylink')
